...
struct Constants {
    ...
    static let APRENDIZAJE_PORCENTAJE_COMPRESIONES_VALIDAS = -1.0
    static let APRENDIZAJE_PORCENTAJE_INSUFLACIONES_VALIDAS = -1.0
    static let APRENDIZAJE_DURACION_SEGUNDOS_COMPRESION_INSUFLACION = 30.0
    static let APRENDIZAJE_DURACION_SEGUNDOS_FINAL = 60.0
