...
public class AprendiendoRCPPaso8Activity extends AppCompatActivity {
    ...
    private int primerCiclo = 0, mediosSegundos = 0, segundoCiclo = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(AprendiendoRCPPaso8Activity.this, HomeActivityPracticante.class);
        ...
        if (getIntent().getExtras() != null && getIntent().getSerializableExtra("instantes") != null) {
            ...
            ciclosInsuflaciones.setText("Ciclo de insuflaciones: " + (primerCiclo + segundoCiclo));
